      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Principais oportunidades de automação com IA que identificamos em outras clínicas. Visando para reduzir gargalos, aumentar eficiência e gerar impacto imediato no faturamento.
          </p>
        </div>
